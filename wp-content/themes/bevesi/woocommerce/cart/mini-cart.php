...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<div class="products <?php echo esc_attr( $args['list_class'] ); ?>">
		<?php
					...
					<div class="product-wrapper">
						<div class="product-inner">
							<div class="thumbnail-wrapper">
								<div class="product-thumbnail">
									<?php if ( empty( $product_permalink ) ) : ?>
										<?php echo bevesi_sanitize_data($thumbnail); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
									<?php else : ?>
							...
							echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								...
								sprintf(
									'<a href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s" data-success_message="%s"><i class="klb-icon-x"></i></a>',
									...
									/* translators: %s is the product name */
									esc_attr( sprintf( __( '&ldquo;%s&rdquo; has been removed from your cart', 'bevesi' ), wp_strip_all_tags( $product_name ) ) )
								),
								$cart_item_key
							);
							?>
...
<?php else : ?>
		<div class="site-mini-cart-empty">
			...
			<p><?php esc_html_e( 'No products in the cart.', 'bevesi' ); ?></p>
		</div>
