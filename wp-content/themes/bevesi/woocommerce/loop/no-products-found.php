...
<div class="empty-content">
	...
	<div class="empty-text">
		<h3 class="entry-title"><?php esc_html_e('No products found!', 'bevesi'); ?></h3>
		<div class="entry-description">
			<p><?php wc_print_notice( esc_html__( 'No products were found matching your selection.', 'bevesi' ), 'notice' ); ?></p>
