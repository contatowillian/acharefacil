...
@media screen and (min-width: 769px)  {
    ...
    .search-results .imagem_anunciante_resultado{
        width: 184px !important;
        border-radius: 10px;
    }

    .home .elementor-1134 .carrosel_anunciantes_home  .slick-slide{
        width: 236px;
        height: 350px;
        max-height: 350px;
...
.search-results  .product + .product{
    padding-top: 0.75rem !important;
    padding-bottom: 0.75rem !important;
}

.search-results .phones{
    font-weight: bold;
    font-size: 14px;
}

.search-results .klb-post .woocommerce-pagination  ul li{
    list-style-type: none !important; 
}

.search-results  .site-pagination ul li > *.current, .woocommerce-pagination ul li > *.current, .pagination-wrap ul li > *.current{
     color:  #aaa !important;
}

.search-results .phones .klb-icon-phone{
    font-size: 20px;
    margin-left: -3px;
}
.search-results  .product .product-thumbnail-wrapper .product-buttons .product-button.product-wishlist a{
    display: none !important;
}

.search-results .klb-page-title{
  display: none !important;
}
...
#carrosel_anunciantes_1{
    text-align: center;
    width: 100%;
    display: block;
}

#carrosel_anunciantes_recentes{
    text-align: center;
    width: 100%;
    display: block;
}
...
@media (max-width: 600px) {
    ...
    #carrosel_anunciantes_recentes .quadro_anuncio_recente_home{
        margin-left: 17vw;
    }
    #carrosel_anunciantes_recentes .slick-dots{
        margin-left: -10vw;
    }
    ...
    .elementor-1134 .elementor-element.elementor-element-aa807ee{
    ...
    #carrosel_anunciantes_recentes .slick-track{
        margin-left: 2% !important;
    }

    #carrosel_anunciantes_recentes  h3{
        margin-left: -2% !important;
    }
    ...
    .search-results  .single-product-wrapper .product_title{
        font-size: 5.2vw;
        font-weight: 600;
        width: 99%;
        padding-left: 9px;
...
<style>
 ...
 .site-slider-categorias .slick-nav {
   position: absolute;
 ...
 .site-slider-categorias .slick-nav svg {
   position: relative;
   width: 90%;
   height: auto;
 }
 .site-slider-categorias .slick-nav.slick-prev {
    left: -2vw;
    width:  1.5rem;
    height:  1.5rem;
 ...
 .site-slider-categorias .slick-nav.slick-prev svg {
    left: -0.125rem;
 }
 .site-slider-categorias .slick-nav.slick-next {
    right: -2vw;
    width: 1.5rem;
    height: 1.5rem;
    border: 1px solid var(--color-black);
 ...
 .site-slider-categorias .slick-nav.slick-next svg {
    right: -0.125rem;
 }
 .site-slider-categorias.arrows-black .slick-nav {
   color: var(--color-white);
   background-color: var(--color-black);
 }
 .site-slider-categorias.arrows-black .slick-nav:hover {
   background-color: var(--color-gray-800);
 }
 .site-slider-categorias.arrows-white .slick-nav {
   color: var(--color-black);
   background-color: var(--color-white);
   -webkit-box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.04), 0 2px 4px -2px rgba(0, 0, 0, 0.04);
           box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.04), 0 2px 4px -2px rgba(0, 0, 0, 0.04);
 }
 .site-slider-categorias.arrows-style-long .slick-nav {
   width: 1.5rem;
   height: 2.875rem;
 }
 @media screen and (min-width: 576.1px) {
   ...
   .site-slider-categorias.arrows-style-long .slick-nav svg {
     width: 54%;
   }
 }
 .site-slider-categorias.arrows-style-long .slick-nav.slick-prev {
 ...
 .site-slider-categorias.arrows-style-long .slick-nav.slick-next {
 ...
 .site-slider-categorias.arrows-style-long.carousel-style:not(.bordered) .slick-nav {
   border: 0.0625rem solid var(--color-slate-200);
 }
 .site-slider-categorias.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-prev {
   border-top-right-radius: var(--site-site-radius-default);
   border-bottom-right-radius: var(--site-site-radius-default);
   right: -0.75rem;
 }
 .site-slider-categorias.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-prev svg {
   right: -0.0625rem;
 }
 @media screen and (min-width: 576.1px) {
   .site-slider-categorias.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-prev {
 ...
 .site-slider-categorias.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-next {
   border-top-left-radius: var(--site-site-radius-default);
   border-bottom-left-radius: var(--site-site-radius-default);
   left: -0.75rem;
 }
 .site-slider-categorias.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-next svg {
   left: -0.0625rem;
 }
 @media screen and (min-width: 576.1px) {
   .site-slider-categorias.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-next {
 ...
 .site-slider-categorias.arrows-style-long.carousel-style.bordered .slick-nav.slick-prev {
 ...
 .site-slider-categorias.arrows-style-long.carousel-style.bordered .slick-nav.slick-next {
   border-top: 0.0625rem solid var(--color-slate-200);
   border-bottom: 0.0625rem solid var(--color-slate-200);
 ...
 .site-slider-categorias.arrows-style-rounded .slick-nav {
   width: 2rem;
   height: 2rem;
   border-radius: 50%;
 }
 .site-slider-categorias.arrows-style-rounded .slick-nav svg {
   width: 45%;
 }
 @media screen and (min-width: 576.1px) {
   .site-slider-categorias.arrows-style-rounded .slick-nav {
 ...
 .site-slider-categorias.arrows-style-rounded.arrows-white .slick-nav {
   border: 1px solid var(--color-black);
   -webkit-box-shadow: none;
           box-shadow: none;
 }
 .site-slider-categorias.arrows-style-rounded.carousel-style .slick-nav.slick-prev {
   right: -0.875rem;
 }
 @media screen and (min-width: 576.1px) {
   .site-slider-categorias.arrows-style-rounded.carousel-style .slick-nav.slick-prev {
 ...
 .site-slider-categorias.arrows-style-rounded.carousel-style .slick-nav.slick-next {
   left: -0.875rem;
 }
 @media screen and (min-width: 576.1px) {
   .site-slider-categorias.arrows-style-rounded.carousel-style .slick-nav.slick-next {
 ...
 .site-slider-categorias .slick-dots {
   display: -webkit-box;
   display: -ms-flexbox;
   display: flex;
   -webkit-box-align: center;
 ...
 .site-slider-categorias .slick-dots li {
   display: -webkit-inline-box;
   display: -ms-inline-flexbox;
   display: inline-flex;
   -webkit-box-align: center;
 ...
 .site-slider-categorias .slick-dots li button {
   all: unset;
   display: block;
   font-size: 0;
   width: 0.5rem;
 ...
 .site-slider-categorias .slick-dots li button:hover {
   background-color: var(--color-slate-300);
 }
 .site-slider-categorias .slick-dots li.slick-active button {
   background-color: rgb(var(--site-primary-color));
 }
 .site-slider-categorias.products .slick-list {
 ...
 .site-slider-categorias.products .slick-list .slider-item {
 ...
 .site-slider-categorias.products:has(.product-content-fade) .slick-list {
   z-index: 10;
 }
 @media screen and (min-width: 1024.1px) {
   .site-slider-categorias.products:has(.product-content-fade) .slick-list {
 ...
 .site-slider-categorias.products:has(.product-content-fade) .slick-nav {
   z-index: 11;
 }
 .site-slider-categorias.site-vendors .slick-list {
   margin-right: -0.375rem;
   margin-left: -0.375rem;
 }
 
 .site-slider-categorias:hover .slick-nav {
   opacity: 1;
   visibility: visible;
 ...
 .carrosel_anunciantes_home .slick-nav svg {
   position: relative !important;
   width: 90% !important;
   height: auto !important;
 }
 body .carrosel_anunciantes_home .slick-nav.slick-prev {
    left: -2vw !important;
 ...
 .carrosel_anunciantes_home .slick-nav.slick-prev svg {
    left: -0.125rem;
 }
 body  .carrosel_anunciantes_home .slick-nav.slick-next {
    right: -2vw !important;
    width: 1.5rem !important;
    height: 1.5rem !important;
    border: 1px solid var(--color-black) !important;
 ...
 .carrosel_anunciantes_home .slick-nav.slick-next svg {
    right: -0.125rem;
 }
 .carrosel_anunciantes_home.arrows-black .slick-nav {
   color: var(--color-white);
   background-color: var(--color-black);
 }
 .carrosel_anunciantes_home.arrows-black .slick-nav:hover {
   background-color: var(--color-gray-800);
 }
 .carrosel_anunciantes_home.arrows-white .slick-nav {
   color: var(--color-black);
   background-color: var(--color-white);
   -webkit-box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.04), 0 2px 4px -2px rgba(0, 0, 0, 0.04);
           box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.04), 0 2px 4px -2px rgba(0, 0, 0, 0.04);
 }
 .carrosel_anunciantes_home.arrows-style-long .slick-nav {
   width: 1.5rem;
   height: 2.875rem;
 }
 @media screen and (min-width: 576.1px) {
   ...
   .carrosel_anunciantes_home.arrows-style-long .slick-nav svg {
     width: 54%;
   }
 }
 .carrosel_anunciantes_home.arrows-style-long .slick-nav.slick-prev {
   border-top-left-radius: var(--site-site-radius-small);
   border-bottom-left-radius: var(--site-site-radius-small);
   -webkit-transform: translateX(6px);
           transform: translateX(6px);
 ...
 .carrosel_anunciantes_home.arrows-style-long .slick-nav.slick-next {
   border-top-right-radius: var(--site-site-radius-small);
   border-bottom-right-radius: var(--site-site-radius-small);
   -webkit-transform: translateX(-6px);
           transform: translateX(-6px);
 ...
 .carrosel_anunciantes_home.arrows-style-long.carousel-style:not(.bordered) .slick-nav {
   border: 0.0625rem solid var(--color-slate-200);
 }
 .carrosel_anunciantes_home.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-prev {
   border-top-right-radius: var(--site-site-radius-default);
   border-bottom-right-radius: var(--site-site-radius-default);
   right: -0.75rem;
 }
 .carrosel_anunciantes_home.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-prev svg {
   right: -0.0625rem;
 }
 @media screen and (min-width: 576.1px) {
   .carrosel_anunciantes_home.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-prev {
 ...
 .carrosel_anunciantes_home.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-next {
   border-top-left-radius: var(--site-site-radius-default);
   border-bottom-left-radius: var(--site-site-radius-default);
   left: -0.75rem;
 }
 .carrosel_anunciantes_home.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-next svg {
   left: -0.0625rem;
 }
 @media screen and (min-width: 576.1px) {
   .carrosel_anunciantes_home.arrows-style-long.carousel-style:not(.bordered) .slick-nav.slick-next {
 ...
 .carrosel_anunciantes_home.arrows-style-long.carousel-style.bordered .slick-nav.slick-prev {
   border-top: 0.0625rem solid var(--color-slate-200);
   border-bottom: 0.0625rem solid var(--color-slate-200);
   border-left: 0.0625rem solid var(--color-slate-200);
   right: -0.375rem;
 ...
 .carrosel_anunciantes_home.arrows-style-long.carousel-style.bordered .slick-nav.slick-next {
   border-top: 0.0625rem solid var(--color-slate-200);
   border-bottom: 0.0625rem solid var(--color-slate-200);
   border-right: 0.0625rem solid var(--color-slate-200);
   left: -0.375rem;
 ...
 .carrosel_anunciantes_home.arrows-style-rounded .slick-nav {
   width: 2rem;
   height: 2rem;
   border-radius: 50%;
 }
 .carrosel_anunciantes_home.arrows-style-rounded .slick-nav svg {
   width: 45%;
 }
 @media screen and (min-width: 576.1px) {
   .carrosel_anunciantes_home.arrows-style-rounded .slick-nav {
 ...
 .carrosel_anunciantes_home.arrows-style-rounded.arrows-white .slick-nav {
   border: 1px solid var(--color-black);
   -webkit-box-shadow: none;
           box-shadow: none;
 }
 .carrosel_anunciantes_home.arrows-style-rounded.carousel-style .slick-nav.slick-prev {
   right: -0.875rem;
 }
 @media screen and (min-width: 576.1px) {
   .carrosel_anunciantes_home.arrows-style-rounded.carousel-style .slick-nav.slick-prev {
 ...
 .carrosel_anunciantes_home.arrows-style-rounded.carousel-style .slick-nav.slick-next {
   left: -0.875rem;
 }
 @media screen and (min-width: 576.1px) {
   .carrosel_anunciantes_home.arrows-style-rounded.carousel-style .slick-nav.slick-next {
 ...
 .carrosel_anunciantes_home .slick-dots {
   display: -webkit-box;
   display: -ms-flexbox;
   display: flex;
   -webkit-box-align: center;
 ...
 .carrosel_anunciantes_home .slick-dots li {
   display: -webkit-inline-box;
   display: -ms-inline-flexbox;
   display: inline-flex;
   -webkit-box-align: center;
 ...
 .carrosel_anunciantes_home .slick-dots li button {
   all: unset;
   display: block;
   font-size: 0;
   width: 0.5rem;
 ...
 .carrosel_anunciantes_home .slick-dots li button:hover {
   background-color: var(--color-slate-300);
 }
 .carrosel_anunciantes_home .slick-dots li.slick-active button {
   background-color: rgb(var(--site-primary-color));
 }
 .carrosel_anunciantes_home.products .slick-list {
   margin-right: -0.375rem;
   margin-left: -0.375rem;
 }
 @media screen and (min-width: 576.1px) {
 ...
 .carrosel_anunciantes_home.products .slick-list .slider-item {
   padding-right: 0.375rem;
   padding-left: 0.375rem;
 }
 @media screen and (min-width: 576.1px) {
 ...
 .carrosel_anunciantes_home.products:has(.product-content-fade) .slick-list {
   z-index: 10;
 }
 @media screen and (min-width: 1024.1px) {
   .carrosel_anunciantes_home.products:has(.product-content-fade) .slick-list {
 ...
 .carrosel_anunciantes_home.products:has(.product-content-fade) .slick-nav {
   z-index: 11;
 }
 .carrosel_anunciantes_home.site-vendors .slick-list {
   margin-right: -0.375rem;
   margin-left: -0.375rem;
 }
 
 .carrosel_anunciantes_home:hover .slick-nav {
   opacity: 1;
   visibility: visible;
   -webkit-transform: translateX(0);
           transform: translateX(0);
 ...
 @media screen and (min-width: 576.1px) {
    ...
    .page-id-2162  .site-page-header.style-2 .site-page-header-inner .page-title {
