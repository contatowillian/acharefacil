...
*************************************************************/
function bevesi_local_import_files() {
	return array(
		array(
...
add_filter( 'merlin_import_files', 'bevesi_local_import_files' );

/************************************************************
## Setup Wizard After Import
*************************************************************/
function bevesi_merlin_after_import_setup() {
    ...
    if ( class_exists( 'woocommerce' ) ) {
        ...
        update_option( 'woocommerce_cart_page_id', '240' );
        update_option( 'woocommerce_checkout_page_id', '245' );
        update_option( 'woocommerce_myaccount_page_id', '16' );
    }


}
add_action( 'merlin_after_all_import', 'bevesi_merlin_after_import_setup' );
