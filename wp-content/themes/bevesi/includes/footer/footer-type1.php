<footer class="site-footer footer-type1">
	...
	<?php $subscribe = get_theme_mod('bevesi_footer_subscribe_area',0); ?>
		<?php if($subscribe == 1){ ?>						
			<div id="footer-newsletter" class="site-footer-row footer-row-background-primary footer-row-color-white footer-newsletter-style-1">
				<div class="container">
					<div class="site-footer-inner">
	...
	<?php if ( is_active_sidebar( 'footer-1' ) || is_active_sidebar( 'footer-2' ) || is_active_sidebar( 'footer-3' ) || is_active_sidebar( 'footer-4' ) || is_active_sidebar( 'footer-4' )) { ?>
		...
		<div id="footer-widgets" class="site-footer-row footer-row-background-primary footer-row-color-white border-full">
			<div class="container">
								...
								<div class="widget">
									...
									<?php if(!empty($footersocial)){ ?>
										<div class="site-social">
											<ul class="social-media color-black rounded-style">
	...
	<?php $footercontacts = get_theme_mod('bevesi_footer_contact_icon',0); ?>
		<?php if($footercontacts == 1){ ?>
			...
			<div id="footer-contact" class="site-footer-row footer-row-background-primary footer-row-color-white border-full">
				<div class="container">
