...
/*----------------------------
  Product Type 4
 ----------------------------*/
function bevesi_product_type4($stockprogressbar = '', $stockstatus = '', $shippingclass = '', $countdown = ''){
	global $product;
	global $post;
	global $woocommerce;
	...
	$gallery = get_theme_mod('bevesi_product_hover_gallery') == 1 ? 'product-thumbnail' : '';
		...
		$output .= '<div class="product-wrapper with-content-fade product-type-1 product-type-4">';
