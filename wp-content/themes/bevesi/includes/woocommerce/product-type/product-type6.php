...
/*----------------------------
  Product Type 6
 ----------------------------*/
function bevesi_product_type6($stockprogressbar = '', $stockstatus = '', $shippingclass = '', $countdown = ''){
	global $product;
	global $post;
	global $woocommerce;
	...
	$gallery = get_theme_mod('bevesi_product_hover_gallery') == 1 ? 'product-thumbnail' : '';
		...
		$output .= '<div class="product-wrapper with-content-fade product-type-6">';
		...
		$output .= '<div class="product-content-fade style-2"></div>';
