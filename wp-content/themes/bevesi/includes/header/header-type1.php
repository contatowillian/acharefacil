<header id="masthead" class="site-header header-type1">
        ...
        <div class="container">
			<div class="site-header-inner">
						...
						<?php $elementor_page = get_post_meta( get_the_ID(), '_elementor_edit_mode', true ); ?> 
							...
							<?php if($elementor_page){ ?>
								<a href="<?php echo esc_url( home_url( "/" ) ); ?>" title="<?php bloginfo("name"); ?>">
									<?php if(isset(bevesi_page_settings('logo')['url']) && !empty(bevesi_page_settings('logo')['url']) ){ ?>
				...
				<div class="col display-none display-inline-flex-laptop align-items-center flex-1">
					...
					<?php bevesi_header_search_input(); ?>  
	...
	<?php /*   <div id="header-bottom" class="site-header-row site-header-bottom header-row-bg-white border-full display-none display-block-laptop">
        <div class="container">
			<div class="site-header-inner">
				<div class="col display-inline-flex align-items-center justify-start">
					<?php bevesi_sidebar_menu(); ?>    
