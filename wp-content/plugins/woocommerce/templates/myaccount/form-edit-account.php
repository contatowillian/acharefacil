...
<div class='form_cadastro_divulgue_seu_negocio'>

<div class="elementor-element elementor-element-d778c1f elementor-widget elementor-widget-bevesi-page-banner" data-id="d778c1f" data-element_type="widget" data-widget_type="bevesi-page-banner.default">
	<div class="elementor-widget-container">
<div class="site-page-header style-1"><div class="container"><div class="site-page-header-inner"><h1 class="page-title">Divulgue seu Negócio</h1><div class="entry-description"><p>Divulgue seu negócio gratuitamente no Achar é Fácil</p></div><!-- entry-description --></div><!-- site-page-header-inner --></div><!-- container --></div><!-- site-page-header -->		</div>
	</div>
...
<form class="woocommerce-EditAccountForm edit-account" action="/my-account/edit-account<?php echo $link_etapa; ?>" id='form_cadastro_anunco_wizard' method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first cadastro-etapa-1">
		<label for="account_first_name"><?php esc_html_e( 'First name', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
		<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_first_name" id="account_first_name" autocomplete="given-name" value="<?php echo esc_attr( $user->first_name ); ?>" />
	</p>
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last cadastro-etapa-1">
	...
	<fieldset>
		<legend class='cadastro-etapa-1'><?php esc_html_e( 'Password change', 'woocommerce' ); ?></legend>
