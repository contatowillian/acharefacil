...
return array(
	...
	'providers'  => array(
		...
		'Google'     => array(
			'enabled' => ( get_option( 'ywsl_google_enable' ) === 'yes' ),
			'keys'    => array(
		...
		'Facebook'   => array(
			'enabled'        => ( get_option( 'ywsl_facebook_enable' ) === 'yes' ),
			'keys'           => array(
		...
		'Twitter'    => array(
			'enabled'      => ( get_option( 'ywsl_twitter_enable' ) === 'yes' ),
			'keys'         => array(
		...
		'LinkedIn'   => array(
			'enabled' => ( get_option( 'ywsl_linkedin_enable' ) === 'yes' ),
			'keys'    => array(
		...
		'Yahoo'      => array(
			'enabled' => ( get_option( 'ywsl_yahoo_enable' ) === 'yes' ),
			'keys'    => array(
		...
		'Foursquare' => array(
			'enabled' => ( get_option( 'ywsl_foursquare_enable' ) === 'yes' ),
			'keys'    => array(
		...
		'Live'       => array(
			'enabled' => ( get_option( 'ywsl_live_enable' ) === 'yes' ),
			'keys'    => array(
		...
		'Instagram'  => array(
			'enabled' => ( get_option( 'ywsl_instagram_enable' ) === 'yes' ),
			'keys'    => array(
		...
		'Paypal'     => array(
			'enabled' => ( get_option( 'ywsl_paypal_enable' ) === 'yes' ),
			'keys'    => array(
				'id'      => get_option( 'ywsl_paypal_key' ),
				'secret'  => get_option( 'ywsl_paypal_secret' ),
				'sandbox' => ( get_option( 'ywsl_paypal_environment' ) === 'sandbox' ),
			),
		),


		'Tumblr'     => array(
			'enabled' => ( get_option( 'ywsl_tumblr_enable' ) === 'yes' ),
			'keys'    => array(
		...
		'Vkontakte'  => array(
			'enabled' => ( get_option( 'ywsl_vkontakte_enable' ) === 'yes' ),
			'keys'    => array(
		...
		'GitHub'     => array(
			'enabled' => ( get_option( 'ywsl_github_enable' ) === 'yes' ),
			'keys'    => array(
	...
	'debug_mode' => ( get_option( 'ywsl_enable_log' ) === 'yes' ),
