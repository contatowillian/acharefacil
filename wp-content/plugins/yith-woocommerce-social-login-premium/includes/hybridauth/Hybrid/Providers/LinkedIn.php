...
class Hybrid_Providers_LinkedIn extends Hybrid_Provider_Model_OAuth2 {
	...
	function getUserProfile() {
		...
		$url = $this->api->api_base_url . "userinfo";

		$response = $this->api->request( $url, array(), "GET" );
		...
		$this->user->profile->photoURL      = isset( $response->picture ) ? $response->picture : "";
