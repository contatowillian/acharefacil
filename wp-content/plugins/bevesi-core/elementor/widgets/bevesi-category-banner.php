...
class Bevesi_Category_Banner_Widget extends Widget_Base {
    use Bevesi_Helper;
	
    public function get_name() {
        return 'bevesi-category-banner';
    }
	...
	protected function register_controls() {
		...
		$this->bevesi_query_elementor_controls($post_count = 6, $column = 6, $carousel = 'yes');
		...
		$defaultimage = plugins_url( 'images/banner-37.jpg', __DIR__ );
        ...
        $this->add_control( 'title',
            [
                ...
                'default' => 'Emplastisk or vahunt primatet  debur',
		...
		$this->add_control( 'desc',
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'default' => 'Savunar teleck rer hådat emedan ekotris inklusive.',
	...
	protected function render() {
		...
		$output .= '<div class="grid-row flex flex-wrap align-items-center border-b border-color-slate-200">';
		$output .= '<div class="column padding-20 w-full mobile:w-[280px]">';
		...
		$output .= '</div><!-- column -->';
		$output .= '<div class="column padding-20 w-full mobile:flex-1">';
		$output .= '<div class="site-banner banner-align-center banner-justify-start banner-color-custom" style="--banner-desktop-height: 275px; --banner-laptop-height: 275px; --banner-tablet-height: 275px; --banner-mobile-height: 380px; --banner-color: #FFF;">';
		$output .= '<div class="site-banner-content">';
		$output .= '<div class="site-banner-inner gap-small width-50 width-40-desktop padding-24 padding-36-tablet padding-46-desktop">';
		...
		$output .= '<h2 class="entry-title text-2xl mobile:text-3xl font-bold tracking-tight laptop:mb-3">'.esc_html($settings['title']).'</h2>';
		...
		$output .= '</div><!-- column -->';
		$output .= '</div><!-- grid-row -->';
		$output .= '<div class="grid-row padding-20">';
