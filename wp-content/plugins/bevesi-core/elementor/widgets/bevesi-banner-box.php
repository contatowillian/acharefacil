...
class Bevesi_Banner_Box_Widget extends Widget_Base {

    public function get_name() {
        return 'bevesi-banner-box';
    }
	...
	protected function register_controls() {
		...
		$this->add_control( 'subtitle',
            [
                ...
                'label_block' => true,
                'default' => 'Midat pugyplabel nomöng.',
        ...
        $this->add_control( 'desc',
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'default' => 'Savunar teleck rer hådat emedan ekotris inklusive exossade, för ultrav. ',
	...
	protected function render() {
		...
		echo '<div class="site-banner-inner gap-small width-full padding-24">';
		...
		if($settings['title']){
			echo '<h2 class="entry-title text-[26px] font-bold tracking-tight laptop:mb-3">'.esc_html($settings['title']).'</h2>';
		}
		if($settings['desc']){
			echo '<div class="entry-description">';
			echo '<p class="text-sm">'.esc_html($settings['desc']).'</p>';
