...
jQuery(document).ready(function ($) {
	...
	$(document).on('bevesiShopPageInit', function () {
		bevesiThemeModule.infinitescroll();
	});
	
	bevesiThemeModule.infinitescroll = function() {
		...
		$(window).data('ajaxready', true).scroll(function(e) {
			...
			if($(window).scrollTop() >= $('.woocommerce .main-content .products').offset().top + $('.woocommerce .main-content .products').outerHeight() - window.innerHeight) {
