<?php
if(get_theme_mod('bevesi_single_image_zoom') == 1 || bevesi_ft() == 'imgzoom'){
	
/*************************************************
## Scripts
*************************************************/
function bevesi_image_zoom_scripts() {
...
add_action( 'wp_enqueue_scripts', 'bevesi_image_zoom_scripts' );
...
function bevesi_image_zoom_setup() {
	add_theme_support( 'wc-product-gallery-zoom' );
}
add_action( 'after_setup_theme', 'bevesi_image_zoom_setup' );
