			                        ...
			                        <tbody>
			                            ...
			                            <tr class="email_subject_and_body_message">
			                                ...
			                                <td>
			                                	...
			                                	<label class="fcpfw_comman_link"><?php echo __('This Option Available in ','custom-fields-account-for-woocommerce-registration');?> <a href="https://www.plugin999.com/plugin/custom-fields-account-registration-for-woocommerce/" target="_blank"><?php echo __('Pro Version','custom-fields-account-for-woocommerce-registration');?></a></label>
			                                </td>
			                            </tr>
			                            <tr class="email_subject_and_body_message">
			                                <th>
		...
		<form method="post">
			<table class="meta_box_table">
				<tbody>
					<tr >
						<th>
							<label><?php echo __('Field Enable','custom-fields-account-for-woocommerce-registration-pro');?></label>
						</th>
						<td>
							<?php
							$custom_field_checkbox = get_post_meta($post->ID,'custom_field_checkbox',true);
					...
					<tr>
						...
						<td>
							...
							<label class="cfafw_common_link"><?php echo __('Some Types Only available in ','custom-fields-account-for-woocommerce-registration');?><a href="https://www.plugin999.com/plugin/custom-fields-account-registration-for-woocommerce/" target="_blank"><?php echo __('pro version','custom-fields-account-for-woocommerce-registration');?></a></label>
						</td>
					</tr>
