<?php      
	...
	{
		if ( is_admin() && isset( $_GET['page'] ) && $_GET['page'] === 'custom-fields-registration-settings' || isset($_GET['post_type']) && $_GET['post_type'] === 'wporg_custom_field' || isset($_GET['post']) && get_post_type($_GET['post']) === 'wporg_custom_field' ) {
